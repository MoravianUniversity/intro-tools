import{i as e}from"./function-planner-CKmk2wE4.js";import"./ui-BOE0KQBr.js";import"./yjs-DU2MbpST.js";const t={functions:[{key:1,name:"main",io:"indirect",readOnly:["name","desc","params","returns"]},{key:2,name:"read_list_of_students",desc:"Read all of the names of students from the given file into a list.",params:[],returns:[{type:"list of str",desc:"the student names from the file"}],io:"none",testable:!1,code:`with open("students.txt") as file:
